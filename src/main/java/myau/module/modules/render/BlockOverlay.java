...
public class BlockOverlay extends Module {
  ...
  public final ModeProperty mode =
      new ModeProperty("mode", 0, new String[] {"Box", "OtherBox", "Outline"});
  public final ModeProperty colorMode =
      new ModeProperty("color", 0, new String[] {"HUD", "Custom"});
  ...
  public final IntProperty red =
      new IntProperty("red", 68, 0, 255, () -> this.colorMode.getValue() == 1);
  public final IntProperty green =
      new IntProperty("green", 117, 0, 255, () -> this.colorMode.getValue() == 1);
  public final IntProperty blue =
      new IntProperty("blue", 255, 0, 255, () -> this.colorMode.getValue() == 1);
  ...
  private BlockPos getCurrentBlock() {
    if (mc.objectMouseOver == null
        || mc.objectMouseOver.typeOfHit != MovingObjectPosition.MovingObjectType.BLOCK) return null;
  ...
  private Color getOverlayColor() {
    if (this.colorMode.getValue() == 0) {
      ...
      return new Color(
          hudColor.getRed(), hudColor.getGreen(), hudColor.getBlue(), this.alpha.getValue());
    }
    return new Color(
        this.red.getValue(), this.green.getValue(), this.blue.getValue(), this.alpha.getValue());
  }
