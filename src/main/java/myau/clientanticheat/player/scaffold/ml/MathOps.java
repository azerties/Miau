...
/**
 * Math utilities for neural network operations. Ported from MX Project's
 * kireiko.dev.millennium.ml.logic.rnn.util.MathOps
 */
final class MathOps {
  private MathOps() {}
  ...
  static double[] xavierUniform(Random rng, int size, int fanIn, int fanOut) {
  ...
  static double[] orthogonal(Random rng, int n) {
