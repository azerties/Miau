...
import myau.ui.clickgui.ConfigWindow;
...
public class FaithsClickGui extends GuiScreen {
  ...
  private void refreshWindows() {
    ...
    java.util.LinkedHashMap<String, List<Module>> cats =
        myau.Myau.moduleManager.getModulesByCategory();
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    myau.module.modules.render.ClickGUI guiModule =
        (myau.module.modules.render.ClickGUI)
            myau.Myau.moduleManager.modules.get(myau.module.modules.render.ClickGUI.class);
